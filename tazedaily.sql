...
ALTER TABLE USER ADD CONSTRAINT UX_USER_LOGIN UNIQUE(LOGIN);       
ALTER TABLE BOOKMARK ADD CONSTRAINT UX_BOOKMARK__NEWSARTICLE_ID UNIQUE(NEWSARTICLE_ID);
ALTER TABLE USER ADD CONSTRAINT UX_USER_EMAIL UNIQUE(EMAIL);       
